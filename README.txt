...
o comando python -m SimpleHTTPServer, uma vez estando na CG-T2. Após isso, abrir no browser o endereço http://localhost:8000

Caso a versão instalada do Python seja a 3.0 ou mais, executar comando python2.7 -m SimpleHTTPServer.
